package com.ssafy.searchservice.exception.handler;
...
import com.ssafy.searchservice.exception.exception.*;
import com.ssafy.searchservice.service.ErrorResponseService;
...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleFoodNotFoundException(FoodNotFoundException e) {
		return errorResponseService.getErrorResponse(NO_CONTENT, HttpStatus.NO_CONTENT, e);
	}
	...
	protected ResponseEntity<ErrorResponse> handleIngredientNotFoundException(IngredientNotFoundException e) {
		return errorResponseService.getErrorResponse(NO_CONTENT, HttpStatus.NO_CONTENT, e);
	}
	/**
